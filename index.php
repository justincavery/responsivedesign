...
<body class="home">
	...
	<div class="section">
		<section class="home-slider">
			<ul>
				<li><a href="article-dan-mall.php">
		...
		<section class="news-listing">
			...
			<a href="studios.html" class="button light">More News</a>
		</section>
	</div>
	<div class="content">

	<section id="imnew" class="starting-rwd">
			<section class="home-cta">
			<!-- Not really feeling this section any more,
			<a href="#" ><h2>Responsive Design.is</h2></a>
			-->
			<span class="cta-white">Responsive design is the combination of <a href="#">flexible grids</a>, <a href="#">flexible images</a> and <a href="#">media queries</a>. It allows you to write once, publish everywhere.</span>
			</section>
	...
	<div class="row">
		<div class="section-box">
			<h2>New<span> to Repsonsive Designs?</span></h2>
			...
			<button id="clicknew" class="button dark">Get Started</button>
		</div>
		<div class="section-box">
			<h2>Learn<span> but I want to check & improve my techniques</span></h2>
			...
			<button id="clickint" class="button dark">Learn More</button>
		</div>
		<div class="section-box">
			<h2>Inspire<span> needed from existing sites built already.</span></h2>
			...
			<a href="frameworks.php" class="button dark">Be inspired</a>
		</div>
	</div>
</section>
		<section id="intermediate" class="rwd-sections">
